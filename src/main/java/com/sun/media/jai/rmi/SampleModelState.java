...
public class SampleModelState extends SerializableStateImpl {
  ...
  */
  ...
  /**
    ...
    */
  public SampleModelState(final Class c, final Object o, final RenderingHints h) {
    super(c, o, h);
  }
  ...
  private void writeObject(final ObjectOutputStream out) throws IOException {
    final SampleModel sampleModel = (SampleModel) this.theObject;
  ...
  private void readObject(final ObjectInputStream in) throws IOException, ClassNotFoundException {
    ...
    final int sampleModelType = in.readInt();
