...
//    registerCodec(new TIFFCodec());
   ...
   */
  public static ImageEncoder createImageEncoder(
      final String name,
  ...
  public static String[] getDecoderNames(final SeekableStream src) {
    ...
    final Enumeration enumeration = codecs.elements();
    final Vector nameVec = new Vector();

    final String opName = null;
    while (enumeration.hasMoreElements()) {
      final ImageCodec codec = (ImageCodec) enumeration.nextElement();
   ...
   * rgb+alpha <code>ColorModel</code> is returned.
   */
  public static ColorModel createComponentColorModel(final SampleModel sm, final ColorSpace cp) {
    if (cp == null) {
   ...
   */
  public static boolean isIndicesForGrayscale(final byte[] r, final byte[] g, final byte[] b) {
